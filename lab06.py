...
num_stars = 0
#question 5 loading a save game
   ...
   &   (  @    (   / /   *    @  .   /  
    ...
    while input_invalid and attempts<3:
        ...
        if num_dream_lvls.isnumeric():
            ...
            if num_dream_lvls in range(0, 3):
                ...
                print("Your input is invalid. Please enter a number between 0 and 3")
        else:
            print("Your input is invalid. Please enter a number between 0 and 3")

    if num_dream_lvls != 0 and input_invalid is not False:
        health_points -= 1
    ...
    if not input_invalid:
        ...
        with open("save.txt", "a") as f:
            if hero_won:
                save_mag=f"Hero {short_name} has killed the monster with {num_stars} stars"
            else:
                save_mag="Monster has killed the hero previously" 
