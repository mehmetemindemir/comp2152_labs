...
# Q2 Roll for monster magic power

monster_power_keys = list(monster_powers.keys())
...
print(f" monster got {monster_power}, increasing their combat strenght t0:  {m_combat_strength}")
